...
export default function MarkEntry({dat,code}) {
  ...
  function validate(obj) {
    ...
    if (!obj.admission || !obj.class_id || !obj.code || !obj.exam_id || !obj.mark || !obj.outOf || !obj.subject_code || !obj.term_id || !obj.year) {
      return false;
    }
...
if(validate(formValues)){
  HttpService.postWithoutAuth('/marks/create', formValues)
  .then((response) => {
